...
# ---- 1. network + target ----
step "1/6  sandbox up (labnet + $TARGET_NAME)"
bash sandbox_up.sh || die "sandbox_up.sh"

# ---- 2. isolation proof (Gate A) ----
step "2/6  verify isolation (Gate A)"
...
step "3/6  grant hexstrike user access (ACL)"
...
step "6/6  prove isolation on the live server"
